...
instructions = ['add', 'sub', 'goto', 'mov', 'jz', 'halt', 'wb', 'ww', 'lshft', 'rshft', 'and', 'mod']
...
def encode_instruction(inst, ops):
   if inst == 'add' or inst == 'sub' or inst == 'mov' or inst == 'jz' or inst == 'lshft' or inst == 'rshft' or inst == 'and' or inst == 'mod':
...
def resolve_names():
   ...
   for line in lines_bin:
      for i in range(0, len(line)):
         if is_name(line[i]):
            if line[i-1] == instruction_set['add'] or line[i-1] == instruction_set['sub'] or line[i-1] == instruction_set['mov'] or line[i-1] == instruction_set['lshft'] or line[i-1] == instruction_set['rshft'] or line[i-1] == instruction_set['and'] or line[i-1] == instruction_set['mod']:
